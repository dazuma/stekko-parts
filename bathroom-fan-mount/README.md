...
* `test-arrangement.stl` includes all the parts, but you probably can't print it directly because it won't fit in most printers.

* Five additional files ending with `.stl` which are basic printable STL exports for the various parts using the default parameters. You can print these files directly if you are okay with using the design unmodified.
